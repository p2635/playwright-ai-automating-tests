...
- **test-automation-patterns.md** – Page Object Model for Playwright tests: file layout under `tests/pages/`, page object conventions, and wiring page objects via Playwright fixtures.
